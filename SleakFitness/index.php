...
<div class="container-centered" style="text-align: center;">
    <div style="font-size: 120px; font-family: 'Righteous', cursive;">Sleak Fitness</div> 
    <div style="font-size: 35px; color: #7A7A7A; display: inline; padding: 30px;"><a href="login-page.php">Login</a></div>
    <div style="font-size: 35px; color: #7A7A7A; display: inline; padding: 30px;"><a href="newuser.php">Create Account</a></div>
</div>
